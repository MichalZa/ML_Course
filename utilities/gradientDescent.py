...
class GradientDescent:
    ...
    def __init__(self, params={}):
        ...
        self.data = params['data'] if 'data' in params and isinstance(params['data'], tuple) else []
    ...
    def _derivative(self):
        ...
        # save
        self.theta0 = self.theta0 - theta0_dx
        self.theta1 = self.theta1 - theta1_dx
    ...
    def calculate(self, starting_t0=None, starting_t1=None, learning_rate=None):
        ...
        if TypeHelper.is_digit(starting_t1, none=True):
            self.theta1 = starting_t1
        if TypeHelper.is_digit(learning_rate, none=True):
